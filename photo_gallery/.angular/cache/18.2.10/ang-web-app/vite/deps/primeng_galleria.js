...
function Galleria_div_0_div_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngClass", ɵɵpureFunction0(6, _c2));
...
var Galleria = class _Galleria extends BaseComponent {
  ...
  constructor(platformId, element, cd, config) {
    super();
  ...
  static ɵfac = function Galleria_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _Galleria)(ɵɵdirectiveInject(PLATFORM_ID), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(PrimeNGConfig));
  };
  static ɵcmp = ɵɵdefineComponent({
    type: _Galleria,
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function GalleriaItem_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵelementEnd();
        ɵɵtemplate(5, GalleriaItem_button_5_Template, 3, 6, "button", 2)(6, GalleriaItem_div_6_Template, 2, 2, "div", 5);
        ɵɵelementEnd();

...
} from "./chunk-H6UK752Q.js";
import {
  TUI_EXPAND_LOADED,
  TuiExpand,
  TuiExpandComponent,
  TuiExpandContent
} from "./chunk-OZABEJ2E.js";
import {
  TuiNumberFormat
} from "./chunk-J7GCEE6B.js";
import {
  TUI_GROUP_DEFAULT_OPTIONS,
  TUI_GROUP_OPTIONS,
  TuiGroup,
  tuiGroupOptionsProvider
} from "./chunk-T4XQX3L2.js";
import {
  TUI_HINT_COMPONENT,
...
var TuiRoot = class _TuiRoot extends TuiPortals {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: _TuiRoot,
      selectors: [["tui-root"]],
      hostAttrs: ["data-tui-version", "4.15.0"],
      hostVars: 6,
      ...
      standalone: true,
      features: [ɵɵProvidersFeature([], [tuiAsPortal(TuiPopupService)]), ɵɵHostDirectivesFeature([TuiPlatform, TuiVisualViewport]), ɵɵInheritDefinitionFeature, ɵɵStandaloneFeature],
